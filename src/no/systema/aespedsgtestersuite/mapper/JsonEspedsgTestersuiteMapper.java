 ...
 * 
 */
package no.systema.aespedsgtestersuite.mapper;
 ...
 * 
 */
public class JsonEspedsgTestersuiteMapper {
	private static final Logger logger = LoggerFactory.getLogger(JsonEspedsgTestersuiteMapper.class.getName());
