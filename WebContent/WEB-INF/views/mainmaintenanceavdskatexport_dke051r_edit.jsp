				    	    ...
				    	    <tr>
				    	    	<c:choose>
					    	    	<c:when test="${not empty model.updateId}">
										...
										<td class="text12" title="dkea_syop">&nbsp;&nbsp;&nbsp;<font class="text12RedBold" >*</font>Angiv.nr - nr.teller</td>
										<td class="text12" >
					    	    	...
					    	    	<c:otherwise>
					    	    		<td class="text12" title="dkea_syav"><font class="text12RedBold" >*</font>Afdeling
								 		...
								 		<tr>
									 		<td width="100%">
										 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
											        ...
											        <tr>
											        	<td class="text12" align="left" >&nbsp;&nbsp;<span title="dkea_14a">CVR/SE-nr.</span></td>
											            <td class="text12" align="left" >&nbsp;<span title="dkea_14c">Navn&nbsp;</span>
											        ...
											        <tr>
											            <td class="text12" align="left"><input type="text" class="inputTextMediumBlue" name="dkea_14a" id="dkea_14a" size="19" maxlength="18" value="${model.record.dkea_14a}"></td>
											            <td class="text12" align="left"><input type="text" class="inputTextMediumBlue" name="dkea_14c" id="dkea_14c" size="30" maxlength="35" value="${model.record.dkea_14c}"></td>
											        </tr>
											        
											        <tr height="4"><td>&nbsp;</td></tr>
											        <tr>
											            <td class="text12" align="left" >&nbsp;<span title="dkea_14d">Adresse</span></td>
											            <td class="text12" align="left" >&nbsp;<span title="dkea_14e">Postnr.</span></td>
											        </tr>
											        <tr>
											        ...
											        <tr>
											        		<td>
												        		<table>
												        		<tr>
												            		<td class="text12" align="left" >&nbsp;<span title="dkea_14f">By</span></td>
												            		<td align="left">&nbsp;</td>
												            	</tr>
												        		<tr>
												            		<td align="left">
