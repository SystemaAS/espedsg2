				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<table id="bilnrList" class="display compact cell-border" width="100%" >
		                ...
		                <c:forEach var="record" items="${model.bilNrList}" varStatus="counter">    
			               ...
			               <td style="width:20%; cursor:pointer;" class="textMediumBlue" id="bilnr_${record.unbiln}@heng_${record.untilh}@country_${record.unland}@trucktype_${record.untrme}@trucknr_${record.untran}@truckdriver_${record.vmnavn}@unretu_${record.unretu}@unretunavn_${record.unretunavn}@dt_${counter.count}" >
